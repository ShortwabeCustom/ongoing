...
/**
 * Evidencia legacy que puede continuar pública en el reporte.
 *
 ...
 *   AND storageKey empieza por "legacy/"
 *   AND url != null
 *   AND url != ""
 *
 * Runtime Evidence nunca se enumera. Las claves y rutas privadas tampoco salen
 * en la respuesta.
 */
